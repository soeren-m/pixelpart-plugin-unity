#ifndef PIXELPART_CUSTOM_MATERIAL_COMMON_URP_HLSL
#define PIXELPART_CUSTOM_MATERIAL_COMMON_URP_HLSL
...
float Pixelpart_SoftParticleFade(float4 fragCoord, float transitionSize) {
	float sceneDepth = LinearEyeDepth(SampleSceneDepth(fragCoord.xy / fragCoord.w), _ZBufferParams);
