...
namespace Pixelpart {
internal class PixelpartParticleSpriteRenderer : IPixelpartParticleRenderer {
	...
	public void Render(Camera camera, Transform transform, Vector3 scale, int layer) {
		...
		Plugin.PixelpartPrepareParticleSpriteVertexData(internalEffect, particleEmitterId, particleTypeId, out int triangleCount, out int vertexCount);
