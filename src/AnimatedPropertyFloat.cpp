...
extern "C" {
UNITY_INTERFACE_EXPORT pixelpart_unity::float_t UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatAt(pixelpart::AnimatedProperty<pixelpart::float_t>* property, pixelpart_unity::float_t position) {
	if(!property) {
...
UNITY_INTERFACE_EXPORT void UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatAddKeyframe(pixelpart::AnimatedProperty<pixelpart::float_t>* property, pixelpart_unity::float_t position, pixelpart_unity::float_t value) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return;
	}
...
UNITY_INTERFACE_EXPORT void UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatRemoveKeyframe(pixelpart::AnimatedProperty<pixelpart::float_t>* property, pixelpart_unity::int_t index) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return;
	}
...
UNITY_INTERFACE_EXPORT void UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatSetKeyframeValue(pixelpart::AnimatedProperty<pixelpart::float_t>* property, pixelpart_unity::int_t index, pixelpart_unity::float_t value) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return;
	}
...
UNITY_INTERFACE_EXPORT void UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatSetKeyframePosition(pixelpart::AnimatedProperty<pixelpart::float_t>* property, pixelpart_unity::int_t index, pixelpart_unity::float_t position) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return;
	}
...
UNITY_INTERFACE_EXPORT pixelpart_unity::int_t UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatKeyframeCount(pixelpart::AnimatedProperty<pixelpart::float_t>* property) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return 0;
	}
...
UNITY_INTERFACE_EXPORT pixelpart_unity::float_t UNITY_INTERFACE_API PixelpartAnimatedPropertyFloatKeyframeValue(pixelpart::AnimatedProperty<pixelpart::float_t>* property, pixelpart_unity::int_t index) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return 0.0f;
	}
