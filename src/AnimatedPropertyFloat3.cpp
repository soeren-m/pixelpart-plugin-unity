...
UNITY_INTERFACE_EXPORT void UNITY_INTERFACE_API PixelpartAnimatedPropertyFloat3EnableFixedCache(pixelpart::AnimatedProperty<pixelpart::float3_t>* property, pixelpart_unity::int_t size) {
	if(!property) {
		pixelpart_unity::lastError = pixelpart_unity::invalidPropertyError;
		return;
	}
